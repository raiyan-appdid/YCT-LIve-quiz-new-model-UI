        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Confirm Entry', style: TextStyle(color: LiveQuizColors.textPrimary, fontSize: 24, fontWeight: FontWeight.bold)),
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: const Text('Upcoming Games', style: TextStyle(color: LiveQuizColors.textPrimary, fontSize: 24, fontWeight: FontWeight.bold)),
              ),
